...
class RightArmControl(object):
    ...
    def go_to_joint_state(self, cur_pos, cur_rot, init_pos, init_rot):
        goal = self.peredelka(cur_pos, cur_rot, init_pos, init_rot)
...
ArmMovement = threading.Thread(target=RightArmControl.go_to_joint_state, args=(RobotArm, cur_pos_arm, cur_rot_arm, arm_init_pos, arm_init_rot))
HeadMovement = threading.Thread(target=HeadControl.go_to_joint_state, args=(RobotHead, cur_rot_head, head_init_rot, cur_pos_head, head_init_pos))
